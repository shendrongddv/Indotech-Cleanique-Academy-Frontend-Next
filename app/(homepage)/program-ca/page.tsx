    ...
    <section className="px-4 py-20 pt-36">
        <div className="container flex md:flex-row flex-col md:justify-between md:items-center gap-16">
            ...
            <div className="w-full md:w-6/12 flex flex-col gap-6 items-center md:items-start text-center md:text-start">
                <Image src="/v2/logo.png" alt="Image" width={274} height={80} className="h-8 md:h-20 w-auto" />
            ...
            <div className="w-full md:w-5/12">
                <figure className="flex justify-center items-center w-full aspect-square">
                    <Image src="/v2/1.png" alt="Image" width={656} height={602} className="w-full h-auto" />
                </figure>
            </div>
        </div>
    </section>
            ...
            <ul className="w-full flex flex-wrap justify-center items-center gap-10">
                ...
                <li key={item.id}
                    ...
                    <figure className="aspect-video overflow-hidden flex justify-center items-center w-full round3x">
                        <Image src={`/v2/${item.media}`} alt={item.title} width={294} height={179}
    ...
    <section className="px-4 py-20  bg-[#1c643f]">
        <div className="container flex flex-col items-center gap-10">
            ...
            <ul className="w-full grid md:grid-cols-3 gap-10">
                ...
                <li key={item.id} className="bg-white p-4 border h-full flex flex-col justify-start">
                    {item.media !== null ? (
                    <figure className=" flex justify-center items-center h-auto w-full border">
                        <Image src={`/v2/${item.media}`} alt={item.title} width={400} height={400}
    ...
    <section className="px-4 py-20">
        <div className="container flex flex-col items-center gap-10">
            ...
            <div className="grid aspect-square md:grid-cols-2 w-full md:w-7/12 gap-4 md:gap-0">
                ...
                {/* COL */}
                <div
                    className="p-4 py-6 md:p-6 bg-[#1C643F] text-white flex flex-col justify-center items-center md:items-start gap-2 rounded-tl-3xl rounded-br-3xl md:aspect-square text-center md:text-start">
                ...
                {/* COL */}
                <div
                    className="p-4 py-6 md:p-6 flex flex-col justify-center items-center md:items-end gap-2 md:text-end bg-[#1C643F] text-white rounded-br-3xl rounded-tl-3xl md:aspect-square text-center">
    ...
    <section className="px-4 py-20  bg-[#1c643f]">
        <div className="container flex flex-col items-center gap-10">
            ...
            <ul className="grid w-full md:w-2/3 gap-6 md:grid-cols-2 md:gap-x-16">
                ...
                <li key={item.id} className="flex justify-start items-start gap-4 md:even:flex-row-reverse">
                    <figure
                        className="flex justify-center items-center aspect-square h-10 md:h-16 rounded-full border shrink-0">
                        <Image src={`/v2/${item.media}`} alt={item.mark} width={80} height={80}
        ...
        <div className="container flex flex-col md:flex-row md:justify-between md:items-start gap-10">
            ...
            <div className="flex-1">
                <figure className="flex justify-center items-center w-full">
                    <Image src="/v2/ROI.png" alt="ROI" width={1476} height={935} className="w-full h-auto" />
                </figure>
            </div>
        </div>
    </section>
    ...
    <section className="px-4 py-20 bg-slate-100">
        <div className="container md:w-2/3 flex flex-col items-center gap-20">
            ...
            <div className="w-full -mt-10 grid md:grid-cols-2 gap-10">
                ...
                <div>
                    <figure
                        className="overflow-hidden flex justify-center rounded-xl border-white border-4 shadow-xl items-center bg-white aspect-square">
                        <Image src="/v2/collage.png" alt="CTA" width={400} height={100}
            ...
            <div className="w-full md:max-w-96 flex flex-col items-center gap-10">
                <figure className="flex justify-center items-center aspect-video">
                    <Image src="/v2/daftar.png" alt="CTA" width={400} height={100} className="w-full h-auto" />
                </figure>

                <div className="grid w-full gap-2 sm:flex sm:justify-center sm:items-center">
                    <Link href="https://app.cleaniqueacademy.com/" target="_blank" rel="noopener noreferrer"
                    ...
                    <Link
                        ...
                        target="_blank" rel="noopener noreferrer" className={cn( buttonVariants({ variant: "default"
                        }), "bg-[#fdd462] text-[#1a643f] hover:text-white" )}>
